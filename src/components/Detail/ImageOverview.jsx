    ...
    <div className="grid grid-rows-2  grid-cols-3  grid-flow-col gap-4 mb-8 h-auto">
      <div className="row-span-2 col-span-3 sm:col-span-2 relative">
        ...
        {windowWidth < 768 ? (
          <>
            <Button
              extraClass="absolute right-32 bottom-0 transform -translate-y-1/2 cursor-pointer"
              text="Share"
              bgColor="#DB5037"
              textColor="white"
              leftIcon={
            ...
            />
            <Button
              extraClass="absolute right-4 bottom-0 transform -translate-y-1/2 cursor-pointer"
              text="1/15"
              bgColor="#DB5037"
              textColor="white"
              leftIcon={
          ...
          <>
            <Button
              extraClass="absolute left-4 bottom-0 transform -translate-y-1/2 cursor-pointer"
              text="Share"
              bgColor="#DB5037"
              textColor="white"
              leftIcon={
            ...
            />
            <Button
              extraClass="absolute left-32 bottom-0 transform -translate-y-1/2 cursor-pointer"
              text="View 15 photos"
              bgColor="#DB5037"
              textColor="white"
              leftIcon={
